...
function TwinSettingsPage() {
  ...
  const s = {
    ...
    templateCard: { width: '160px', padding: '12px 12px 10px', border: '1px solid var(--dsw-alias-border-l2)', borderRadius: '10px', textAlign: 'center' as const, cursor: 'pointer', background: 'var(--dsw-alias-bg-layer-2)', transition: 'all 0.15s' },
