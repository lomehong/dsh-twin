...
function CardsPage() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("p", { style: s5.hint, children: [
      "\u4EBA\u683C\u5361\u662F\u5206\u8EAB\u4EBA\u683C\u7684\u7ED3\u6784\u5316\u6570\u636E\uFF08\u8EAB\u4EFD/\u7B56\u7565/\u6837\u4F8B/\u72B6\u6001\u56DB\u5F20\uFF09\uFF1A\u8EAB\u4EFD\u5361\uFF08\u516C\u5F00/\u79C1\u5BC6\u5206\u7EA7\u2014\u2014\u79C1\u5BC6\u5B57\u6BB5\u8BBF\u5BA2\u89C6\u56FE\u7ED3\u6784\u6027\u7F3A\u5931\uFF09\u3001\u7B56\u7565\u5361\uFF08\u89E6\u53D1\u2192\u52A8\u4F5C\u2192\u5347\u7EA7\uFF0C\u9010\u6761\u53EF\u6D4B\u8BD5\uFF09\u3001 \u6837\u4F8B\u5361\uFF08\u8FD9\u4E48\u8BF4/\u4E0D\u8FD9\u4E48\u8BF4\uFF09\u3001\u72B6\u6001\u5361\uFF08\u968F\u65F6\u95F4\u8870\u51CF\uFF09\u3002\u751F\u6548 = ",
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("b", { children: "\u4E3B\u4EBA\u786E\u8BA4 + \u56DE\u5F52\u901A\u8FC7" }),
      " \u53CC\u6761\u4EF6\uFF0C\u7F3A\u4E00\u4FDD\u5B58\u4E3A\u5019\u9009\u4FEE\u8BA2\u3002"
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { ...s5.status, background: meta.hasEffective ? "var(--dsw-alias-state-success-tertiary)" : "var(--dsw-alias-state-warn-tertiary)", color: meta.hasEffective ? "var(--dsw-alias-state-success-primary)" : "var(--dsw-alias-state-warn-label)" }, children: [
      "\u5F53\u524D\u72B6\u6001\uFF1A",
      meta.hasEffective ? "\u2713 \u751F\u6548" : "\u5019\u9009\uFF08\u65E7\u751F\u6548\u5361\u6216 legacy \u6E32\u67D3\u4E2D\uFF09",
      " \xB7 \u4FEE\u8BA2\u53F7 ",
      meta.revisionNo
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.sec, children: "\u2460 \u8EAB\u4EFD\u5361" }),
    BUILT_IN_FIELDS2.map((def) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s5.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("span", { style: { minWidth: 96, textAlign: "right", fontSize: 12.5, color: "var(--dsw-alias-label-secondary)" }, children: [
          def.label,
          def.visibility === "\u79C1\u5BC6" ? " \u{1F512}" : ""
        ] }),
        def.control === "tone" ? /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("select", { style: s5.small, value: f?.value ?? "", onChange: (e) => set({ value: e.target.value }), children: [
          ...
          "textarea",
          {
            style: { ...s5.wide, minHeight: 44 },
            value: f?.value ?? "",
            onChange: (e) => set({ value: e.target.value })
          }
        ) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("input", { style: s5.input, value: f?.value ?? "", onChange: (e) => set({ value: e.target.value }) }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("select", { style: s5.small, value: f?.visibility ?? def.visibility, onChange: (e) => set({ visibility: e.target.value }), children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.hint, children: "\u4EE5\u4E0A\u4E5D\u9879\u4E3A\u56FA\u5B9A\u8EAB\u4EFD\u5B57\u6BB5\uFF08\u4E0D\u53EF\u5220\u9664\uFF09\uFF1B\u{1F512} \u79C1\u5BC6\u5B57\u6BB5\u8BBF\u5BA2\u89C6\u56FE\u7ED3\u6784\u6027\u7F3A\u5931\u3002\u300C\u505A\u4E8B\u65B9\u5F0F / \u8FB9\u754C\u4E0E\u8F6C\u4EBA\u5DE5\u300D\u8981\u7ED3\u6784\u5316\u65F6\uFF0C\u5728\u4E0B\u65B9\u7B56\u7565\u5361\u9010\u6761\u5F55\u5165\u89C4\u5219\uFF0C\u7136\u540E\u6E05\u7A7A\u5BF9\u5E94\u6587\u672C\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { ...s5.sec, marginTop: 14 }, children: "\u81EA\u5B9A\u4E49\u5B57\u6BB5\uFF08\u53EF\u9009\uFF09" }),
    cards.identity.fields.map((f, i) => (
      // 按 key 判断内置（而非 builtIn 标记）：不依赖后端版本是否回传标记
      BUILT_IN_FIELDS2.some((d) => d.key === f.key) ? null : /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s5.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
          "input",
          {
            style: { ...s5.input, maxWidth: 140 },
            value: f.key,
            placeholder: "\u952E\uFF08\u5982\uFF1A\u6BD5\u4E1A\u9662\u6821\uFF09",
            onChange: (e) => upd((d) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.sec, children: "\u2461 \u7B56\u7565\u5361\uFF08\u89E6\u53D1 \u2192 \u52A8\u4F5C \u2192 \u5347\u7EA7\uFF09" }),
    cards.policy.rules.map((r, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { border: "1px solid #eee", borderRadius: 8, padding: 8, marginBottom: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.row, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "input",
        {
          style: s5.wide,
          value: r.when,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.sec, children: "\u2462 \u6837\u4F8B\u5361\uFF08\u8FD9\u4E48\u8BF4 / \u4E0D\u8FD9\u4E48\u8BF4\uFF09" }),
    cards.exemplars.items.map((x, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { border: "1px solid #eee", borderRadius: 8, padding: 8, marginBottom: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.row, children: /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(
        "input",
        {
          style: s5.wide,
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s5.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("select", { style: s5.small, value: x.source, onChange: (e) => upd((d) => {
          d.exemplars.items[i].source = e.target.value;
        }), children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "\u8BED\u6599", children: "\u8BED\u6599" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("option", { value: "\u7EA0\u6B63", children: "\u7EA0\u6B63" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { style: { ...s5.del, marginLeft: "auto" }, onClick: () => upd((d) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.sec, children: "\u2463 \u72B6\u6001\u5361\uFF08\u8FD1\u671F\u4E0A\u4E0B\u6587\uFF0C\u81EA\u52A8\u8870\u51CF\uFF09" }),
    cards.state.items.map((x, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s5.row, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("select", { style: s5.small, value: x.statementType, onChange: (e) => upd((d) => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.sec, children: "\u4FDD\u5B58\u4E0E\u751F\u6548" }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s5.row, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("label", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s5.row, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { style: s5.btn2, onClick: () => {
        if (window.confirm("\u4ECE legacy twin-config \u8FC1\u79FB\u5230\u4EBA\u683C\u5361\uFF1F\u5F53\u524D\u7F16\u8F91\u5185\u5BB9\u5C06\u88AB\u8986\u76D6\u3002")) void save(true);
      }, children: "\u4ECE\u65E7\u914D\u7F6E\u8FC1\u79FB" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { style: s5.btn2, onClick: () => void doPreview(), children: "\u9884\u89C8\u53CC\u89C6\u56FE\u6295\u5F71" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("button", { style: s5.btn2, onClick: () => void load(), children: "\u5237\u65B0" })
    ] }),
    msg !== null && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: { ...s5.status, background: msg.ok ? "var(--dsw-alias-state-success-tertiary)" : "var(--dsw-alias-state-warn-tertiary)", color: msg.ok ? "var(--dsw-alias-state-success-primary)" : "var(--dsw-alias-state-warn-label)" }, children: msg.text }),
    preview !== null && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { marginTop: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.sec, children: "\u6295\u5F71\u9884\u89C8" }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: s5.row, children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { flex: 1 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.hint, children: "\u4E3B\u4EBA\u89C6\u56FE" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.pre, children: preview.master === "" ? "\uFF08\u7A7A\uFF09" : preview.master })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { flex: 1 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.hint, children: "\u8BBF\u5BA2\u89C6\u56FE\uFF08\u79C1\u5BC6\u5B57\u6BB5\u7ED3\u6784\u6027\u7F3A\u5931\uFF09" }),
          /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.pre, children: preview.guest === "" ? "\uFF08\u7A7A\uFF09" : preview.guest })
        ] })
      ] })
    ] }),
    history.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { style: { marginTop: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.sec, children: "\u4FEE\u8BA2\u53F2\uFF08\u6700\u8FD1 10 \u4E2A\uFF0C\u4E0D\u53EF\u53D8\u5FEB\u7167\uFF09" }),
