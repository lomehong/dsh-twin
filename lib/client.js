...
function FailoverCard() {
  const [state, setState] = (0, import_react2.useState)("checking");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
    "div",
    {
      ...
      children: [
        ...
        state === "unconfigured" && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_jsx_runtime2.Fragment, { children: "\u672A\u914D\u7F6E\u2014\u2014\u5206\u8EAB\u5728\u6A21\u578B\u5957\u9910\u8D85\u9650\u65F6\u4F1A\u76F4\u63A5\u62A5\u9519\u3002\u5EFA\u8BAE\u5728\u300C\u8BBE\u7F6E \u2192 \u6A21\u578B\u5207\u6362\u300D\u914D\u7F6E\u964D\u7EA7\u94FE\u3002" }),
        state === "checking" && "\u68C0\u6D4B\u4E2D\u2026"
      ]
    }
  );
...
function TwinSettingsPage() {
  const [cfg, setCfg] = (0, import_react2.useState)(emptyConfig);
  ...
  const [toolHint, setToolHint] = (0, import_react2.useState)("");
  ...
  const [tab, setTab] = (0, import_react2.useState)("persona");
  const load = (0, import_react2.useCallback)(async () => {
    ...
    try {
      const s3 = await api("/dsh-twin/stats", "GET");
      if (s3.ok && s3.stats) setStats(s3.stats);
    } catch {
    }
    try {
  ...
  function applyPreset(id) {
    ...
    if (!preset) return;
    const hasInput = cfg.identity.name.trim() !== "" || cfg.identity.role.trim() !== "" || cfg.identity.background.trim() !== "" || cfg.persona.style.trim() !== "" || cfg.persona.values.trim() !== "" || cfg.persona.rules.trim() !== "" || cfg.persona.escalation.trim() !== "" || cfg.persona.avoid.trim() !== "" || (cfg.knowledge?.seeds ?? []).some((s3) => s3.trim() !== "");
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.wrap, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("h1", { style: s2.h, children: "\u6570\u5B57\u5206\u8EAB\u8BBE\u7F6E" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("p", { style: s2.sub, children: "\u914D\u7F6E\u4F60\u7684\u6570\u5B57\u5206\u8EAB\uFF1A\u6A21\u677F / \u4EBA\u683C / \u77E5\u8BC6\u3002\u4FDD\u5B58\u540E\u7ACB\u5373\u751F\u6548\uFF08\u4EBA\u683C\u6CE8\u5165\u63D0\u793A\u8BCD\u3001\u77E5\u8BC6\u5199\u5165\u5171\u4EAB\u8BB0\u5FC6\uFF09\u3002\u63D2\u4EF6\u662F\u7EAF\u6846\u67B6\uFF0C\u4EBA\u683C\u662F\u6570\u636E\uFF0C\u53EF\u5BFC\u5165\u5BFC\u51FA\u968F\u8EAB\u643A\u5E26\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.tabBar, children: [["persona", "\u4EBA\u683C"], ["knowledge", "\u77E5\u8BC6"], ["monitor", "\u76D1\u63A7"], ["history", "\u5386\u53F2"]].map(([id, label]) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: tab === id ? s2.tabOn : s2.tab, onClick: () => setTab(id), children: label }, id)) }),
    tab === "persona" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.section, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.secTitle, children: "\u6A21\u677F\u9884\u8BBE" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.templateGrid, children: PRESETS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: cfg.template === p.id ? { ...s2.templateCard, ...s2.templateCardOn } : s2.templateCard, onClick: () => applyPreset(p.id), children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.templateName, children: p.label }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.templateDesc, children: p.desc }),
        cfg.template === p.id && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.templateCheck, children: "\u2713 \u5DF2\u9009" })
      ] }, p.id)) }),
      toolHint && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.hint, children: [
        "\u{1F6E1}\uFE0F ",
        toolHint
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.secTitle, children: "\u4EBA\u683C" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u540D\u5B57" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { style: s2.input, value: cfg.identity.name, onChange: (e) => setI("name", e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u5C0F D" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u8EAB\u4EFD\u5B9A\u4F4D" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { style: s2.input, value: cfg.identity.role, onChange: (e) => setI("role", e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u79C1\u4EBA\u52A9\u7406 / \u7814\u53D1\u52A9\u624B / \u4E13\u5BB6\u987E\u95EE" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u80CC\u666F" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("textarea", { style: s2.textarea, value: cfg.identity.background, onChange: (e) => setI("background", e.target.value), placeholder: "\u4F60\u662F\u8C01\u3001\u61C2\u4EC0\u4E48\u3001\u670D\u52A1\u8C01\u2026" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.hint, children: "\u{1F512} \u4EC5\u6CE8\u5165\u4F60\u81EA\u5DF1\u7684\u4F1A\u8BDD\uFF1B\u8BBF\u5BA2\u4F1A\u8BDD\u4E0D\u542B\u6B64\u5185\u5BB9\u3002\u53EF\u5199\u79C1\u5BC6\u4E8B\u5B9E\uFF08\u65E5\u7A0B\u3001\u9879\u76EE\u3001\u5BB6\u5EAD\u5B89\u6392\u7B49\uFF09\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u8BED\u6C14" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.chipRow, children: TONES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: cfg.persona.tone === t.id ? s2.chipOn : s2.chip, onClick: () => setP("tone", t.id), children: t.label }, t.id)) }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u98CE\u683C\u8865\u5145" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("textarea", { style: s2.textarea, value: cfg.persona.style, onChange: (e) => setP("style", e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u5148\u7ED9\u7ED3\u8BBA\u518D\u7ED9\u4F9D\u636E / \u522B\u7528\u592A\u4E13\u4E1A\u7684\u9ED1\u8BDD\u2026" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u4EF7\u503C\u89C2\u4E0E\u539F\u5219" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("textarea", { style: s2.textarea, value: cfg.persona.values, onChange: (e) => setP("values", e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u4EE5\u4E3B\u4EBA\u5229\u76CA\u4E3A\u5148\uFF1B\u8BDA\u5B9E\u6709\u636E\u3001\u4E0D\u7F16\u9020\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.hint, children: "\u26A0 \u4F1A\u6CE8\u5165\u6240\u6709\u4F1A\u8BDD\uFF08\u542B\u8BBF\u5BA2\uFF09\u2014\u2014\u5206\u8EAB\u5BF9\u4EFB\u4F55\u4EBA\u90FD\u575A\u5B88\u8FD9\u91CC\u7684\u539F\u5219\u3002\u53EA\u5199\u884C\u4E3A\u51C6\u5219\uFF0C\u52FF\u5199\u673A\u5BC6\uFF08\u673A\u5BC6\u8BF7\u5199\u5728\u4E0A\u65B9\u300C\u80CC\u666F\u300D\uFF0C\u4EC5\u4F60\u81EA\u5DF1\u7684\u4F1A\u8BDD\u53EF\u89C1\uFF09\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u51B3\u7B56\u4E0E\u505A\u4E8B\u65B9\u5F0F" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("textarea", { style: s2.textarea, value: cfg.persona.rules, onChange: (e) => setP("rules", e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u5148\u542C\u6E05\u9700\u6C42\u518D\u884C\u52A8\uFF1B\u80FD\u4EE3\u529E\u7684\u4EE3\u529E\uFF0C\u4E0D\u786E\u5B9A\u7684\u5148\u786E\u8BA4\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u8FB9\u754C\u4E0E\u8F6C\u4EBA\u5DE5" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("textarea", { style: s2.textarea, value: cfg.persona.escalation, onChange: (e) => setP("escalation", e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u6D89\u53CA\u91D1\u94B1/\u5BF9\u5916\u627F\u8BFA/\u5BF9\u5916\u53D1\u5E03\u65F6\u8F6C\u4E3B\u4EBA\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u7981\u5FCC" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("textarea", { style: s2.textarea, value: cfg.persona.avoid, onChange: (e) => setP("avoid", e.target.value), placeholder: "\u4F8B\u5982\uFF1A\u4E0D\u64C5\u81EA\u5BF9\u5916\u627F\u8BFA\u3001\u4E0D\u66FF\u4E3B\u4EBA\u505A\u4E3B\u51B3\u5B9A\u3002" })
    ] }),
    tab === "knowledge" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.section, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.secTitle, children: "\u77E5\u8BC6\uFF08\u5171\u4EAB\u8BB0\u5FC6\u79CD\u5B50\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("label", { style: s2.label, children: "\u8BB0\u5FC6\uFF08\u6BCF\u884C\u4E00\u6761\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "textarea",
        {
          style: { ...s2.textarea, minHeight: "80px" },
          value: (cfg.knowledge?.seeds ?? []).join("\n"),
          onChange: (e) => setCfg((prev) => ({ ...prev, knowledge: { seeds: e.target.value.split("\n").map((x) => x.trim()).filter(Boolean) } })),
          placeholder: "\u4F8B\u5982\uFF1A\n\u6211\u662F\u67D0\u516C\u53F8\u7814\u53D1\u8D1F\u8D23\u4EBA\n\u6211\u4EEC\u9879\u76EE\u7528 TypeScript\n\u6BCF\u5468\u4E94\u4E0B\u5348\u5F00\u5468\u4F1A"
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { style: { ...s2.ghost, display: "inline-block", marginTop: "8px" }, children: [
        "\u5BFC\u5165\u77E5\u8BC6\u6587\u4EF6(.txt/.md)",
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { type: "file", accept: ".txt,.md,.markdown,text/plain", style: { display: "none" }, onChange: handleImportKnowledge })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...s2.hint, marginTop: 10 }, children: "\u6B64\u5904\u7F16\u8F91\u7684\u662F\u300C\u79CD\u5B50\u300D\uFF1B\u4FDD\u5B58\u540E\u5199\u5165\u5171\u4EAB\u8BB0\u5FC6\u5E93\u3002\u8981\u67E5\u770B / \u7F16\u8F91 / \u5220\u9664\u5DF2\u5165\u5E93\u7684 \u5355\u6761\u8BB0\u5FC6\uFF08\u542B\u5206\u8EAB\u5BF9\u8BDD\u4E2D\u6C89\u6DC0\u7684\u8BB0\u5FC6\uFF09\uFF0C\u8BF7\u5230\u5DE6\u4FA7\u300C\u8BB0\u5FC6\u300D\u6807\u7B7E\u9875\uFF08dsh-memory \u63D0\u4F9B\uFF09\u3002" })
    ] }),
    tab === "monitor" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.section, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.secTitle, children: "\u8FD0\u884C\u76D1\u63A7" }),
      monitor ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.hint, children: [
        "\u4F1A\u8BDD ",
      ...
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.hint, children: "\u6682\u65E0\u76D1\u63A7\u6570\u636E\uFF08\u4F7F\u7528\u5206\u8EAB\u4F1A\u8BDD\u540E\u51FA\u73B0\uFF09\u3002" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(FailoverCard, {})
    ] }),
    tab === "history" && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.section, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.secTitle, children: "\u5386\u53F2\u7248\u672C" }),
      history.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.hint, children: [
        "\u6700\u8FD1 ",
        history.length,
        " \u4E2A\uFF1A",
        history.map((v) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("button", { style: { ...s2.ghost, padding: "2px 8px", fontSize: "12px", margin: "0 4px 4px 0" }, onClick: () => restoreVersion(v.index), children: [
          "\u6062\u590D ",
          new Date(v.ts).toLocaleString()
        ] }, v.index))
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.hint, children: "\u6682\u65E0\u5386\u53F2\u7248\u672C\uFF08\u4FDD\u5B58\u8FC7\u300C\u5206\u8EAB\u8BBE\u7F6E\u300D\u4F1A\u751F\u6210\uFF09\u3002" })
    ] }),
    stats && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.hint, children: [
      "\u72B6\u6001\uFF1A\u8BB0\u5FC6 ",
      stats.memoryTotal,
      " \u6761",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { style: { ...s2.hint, display: "flex", alignItems: "center", gap: 6, cursor: "pointer" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "input",
        {
          type: "checkbox",
    ...
    cfg.becomeDefaultPreset === true && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { ...s2.hint, color: "#c47f17" }, children: "\u26A0 \u52FE\u9009\u540E\u6240\u6709\u65B0\u4F1A\u8BDD\uFF08\u542B\u4F60\u81EA\u5DF1\u7684\u65E5\u5E38\u5DE5\u4F5C\u4F1A\u8BDD\uFF09\u90FD\u5C06\u4F7F\u7528 conversation-first \u5206\u8EAB\u9884\u8BBE\uFF08\u65E0 shell / \u6587\u4EF6\u7CFB\u7EDF\u76F4\u64CD\u5DE5\u5177\uFF09\u3002\u82E5\u4F60\u4E3B\u8981\u5728\u7F51\u9875\u7AEF\u505A\u5F00\u53D1\u5DE5\u4F5C\uFF0C \u5EFA\u8BAE\u4E0D\u52FE\u9009\uFF0C\u6539\u4E3A\u5728\u300C\u624B\u673A\u8FDE\u63A5 \u2192 im-channel \u8BBE\u7F6E\u300D\u91CC\u914D\u7F6E agentPreset: digital-twin\uFF0C \u53EA\u8BA9\u4F01\u5FAE\u4F1A\u8BDD\u8D70\u5206\u8EAB\u4EBA\u683C\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: s2.row, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: s2.btn, disabled: !loaded || saving, onClick: handleSave, children: saving ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u5E76\u751F\u6548" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: s2.ghost, onClick: handlePreviewToggle, children: preview ? "\u6536\u8D77\u9884\u89C8" : "\u9884\u89C8\u6CE8\u5165\u7684\u4EBA\u683C" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { style: s2.ghost, onClick: handleExport, children: "\u5BFC\u51FA\u4EBA\u683C" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("label", { style: s2.ghost, children: [
        "\u5BFC\u5165\u4EBA\u683C",
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("input", { type: "file", accept: "application/json", style: { display: "none" }, onChange: handleImport })
      ] })
    ] }),
    preview && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("pre", { style: { ...s2.hint, whiteSpace: "pre-wrap", background: "rgba(127,127,127,0.12)", padding: 10, borderRadius: 8, maxHeight: 260, overflow: "auto" }, children: [
      preview.persona || "\uFF08\u4EBA\u683C\u4E3A\u7A7A\uFF1A\u540D\u5B57/\u98CE\u683C\u7B49\u5B57\u6BB5\u5168\u7A7A\u65F6\u4E0D\u6CE8\u5165\u4EBA\u683C\u6BB5\uFF09",
      preview.guard ? `

${preview.guard}` : ""
    ] }),
    status && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: s2.status, children: status })
  ] });
}
