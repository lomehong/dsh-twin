...
function formatLocal(iso, withSeconds = false) {
  if (!iso) return "";
...
// src/client/mind-asks.ts
var ASKS_FOCUS_EVENT = "dsh-twin:focus-todo";
var asksFocusPending = false;
function markAsksFocus() {
  asksFocusPending = true;
}
function consumeAsksFocus() {
  const v = asksFocusPending;
  asksFocusPending = false;
  return v;
}
async function fetchMindAsks() {
...
async function answerMindAsk(id, answer) {
  try {
...
var EMPTY = { candidates: [], openLoops: [], pendingShadow: [], ledger: { pendingApprovals: 0, blocked: 0, total: 0 }, approvals: [], pendingConfirm: [], regressions: [], reaches: [], mindAsks: [] };
...
function DashboardPage() {
  ...
  const load = (0, import_react.useCallback)(async () => {
    try {
      const [learning, profiles, shadow, ledger, approvals, regressions, proactive, board, mindAsks] = await Promise.all([
        ...
        api("/dsh-ledger/approvals").catch(() => null),
        api("/dsh-regression/reports").catch(() => null),
        api("/dsh-twin/proactive").catch(() => null),
        api("/dsh-task-board/state").catch(() => null),
      ...
      const pendingConfirm = (board?.state?.tasks ?? []).filter((t) => t.lastStatus === "\u5F85\u786E\u8BA4").map((t) => ({ id: t.id, title: t.title, summary: t.runs?.[t.runs.length - 1]?.summary ?? "" }));
  ...
  const confirmRun = async (taskId, approved) => {
    setBusy(true);
    try {
      ...
      const payload = await resp.json();
      setMsg(payload.ok === true ? approved ? `\u5DF2\u786E\u8BA4\u3008${taskId}\u3009\u5B8C\u6210\u2014\u2014\u7ED3\u679C\u5DF2\u6C89\u6DC0\u8BB0\u5FC6` : `\u5DF2\u9A73\u56DE\u3008${taskId}\u3009\uFF08\u8BB0\u5931\u8D25\uFF09` : `\u786E\u8BA4\u5931\u8D25\uFF1A${payload.error ?? "\u672A\u77E5\u539F\u56E0"}`);
      await load();
    } catch (e) {
      setErr(e instanceof Error ? e.message : String(e));
    } finally {
  ...
  const asksRef = (0, import_react.useRef)(null);
  ...
  (0, import_react.useEffect)(() => {
    const check = () => {
      ...
      window.setTimeout(() => {
        asksRef.current?.scrollIntoView({ behavior: "smooth", block: "start" });
      }, 80);
    };
    check();
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.wrap, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.cards, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatCard, { name: "\u7B49\u4F60\u7ED9", ctx: "\u5FC3\u667A\u8BF7\u6C42\u5355 \xB7 \u7B54\u590D\u5373\u6267\u884C", count: d.mindAsks.length, absent: missing.mind === true }),
    ...
    d.mindAsks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { ref: asksRef, style: { ...s.section, ...flash ? { color: "var(--dsw-alias-state-warn-primary)" } : {} }, children: [
        "\u5FC3\u667A\u8BF7\u6C42\u5355\uFF08",
        d.mindAsks.length,
        "\uFF09\u2014\u2014TA \u5728\u7B49\u4F60\u7684\u7B54\u590D\u624D\u80FD\u7EE7\u7EED"
      ] }),
      d.mindAsks.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(AskItem, { ask: a, onDone: (m) => {
        setMsg(m);
        void load();
      } }, a.id))
    ] }),
    d.approvals.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.section, children: [
        "\u5F85\u6279\u5BA1\u6279\uFF08",
        d.approvals.length,
        "\uFF09"
      ] }),
      d.approvals.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.item, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: s.chip, children: a.actionType }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: s.itemText, children: [
          a.targetScope,
          a.expiresAt ? ` \xB7 \u4EE4\u724C\u6709\u6548\u671F\u81F3 ${a.expiresAt.slice(11, 16)}` : ""
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn, disabled: busy, onClick: () => void decide(a.id, true), children: "\u6279\u51C6" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btnDanger, disabled: busy, onClick: () => void decide(a.id, false), children: "\u9A73\u56DE" })
      ] }, a.id))
    ] }),
    d.pendingConfirm.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.section, children: [
        "\u5F85\u786E\u8BA4\u81EA\u62A5\uFF08",
        d.pendingConfirm.length,
        "\uFF09\u2014\u2014\u5206\u8EAB\u81EA\u62A5 \u2260 \u5B8C\u6210\uFF0C\u4E3B\u4EBA\u786E\u8BA4\u624D\u662F\u5B8C\u6210"
      ] }),
      d.pendingConfirm.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.item, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: s.chip, children: t.id }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: s.itemText, children: [
          t.title,
          t.summary ? `\uFF1A${t.summary}` : ""
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn, disabled: busy, onClick: () => void confirmRun(t.id, true), children: "\u786E\u8BA4\u5B8C\u6210" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btnDanger, disabled: busy, onClick: () => void confirmRun(t.id, false), children: "\u5224\u5B9A\u5931\u8D25" })
      ] }, t.id))
    ] }),
    ...
    d.candidates.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      d.candidates.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.item, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: s.itemMeta, children: formatLocalDate(c.createdAt) })
      ] }, c.id))
    ] }),
    ...
    d.regressions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.item, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: s.itemMeta, children: formatLocal(d.regressions[0].at) })
      ] })
    ] }),
...
function AskItem({ ask, onDone }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...s.item, flexDirection: "column", alignItems: "stretch" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: s.row, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { ...s.chip, color: "var(--dsw-alias-state-warn-primary)", borderColor: "var(--dsw-alias-state-warn-primary)" }, children: ask.goalTitle ?? "\u8BF7\u6C42" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: s.itemText, children: ask.what }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: s.itemMeta, children: ask.ageHours > 0 ? `\u60AC\u7F6E ${ask.ageHours} \u5C0F\u65F6` : "\u521A\u63D0\u51FA" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: open ? s.btnGhost : s.btn, onClick: () => setOpen((o) => !o), children: open ? "\u6536\u8D77" : "\u7B54\u590D" })
    ] }),
    (ask.why !== void 0 || ask.howto !== void 0) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { fontSize: 11.5, color: "var(--dsw-alias-label-tertiary)", marginTop: 5, lineHeight: 1.55 }, children: [
      ask.why !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        "\u4E3A\u4E86\uFF1A",
        ask.why
      ] }),
      ask.howto !== void 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
        "\u7ED9\u4E86\u4E4B\u540E TA \u4F1A\uFF1A",
        ask.howto
      ] })
    ] }),
    open && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginTop: 8 }, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { ...s.row, marginTop: 6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btn, disabled: sending || text.trim() === "", onClick: () => void send(), children: sending ? "\u6295\u9012\u4E2D\u2026" : "\u53D1\u9001\u7B54\u590D" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { style: s.btnGhost, onClick: () => setOpen(false), children: "\u53D6\u6D88" })
      ] })
    ] })
  ] });
}
    ...
    withRelations.map((p) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: s3.card, children: [
      ...
      p.openLoops.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(import_jsx_runtime3.Fragment, { children: [
        ...
        p.openLoops.map((o) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: s3.loop, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 11, marginLeft: 8 }, children: formatLocalDate(o.openedAt) })
        ] }, o.memoryId))
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: s3.sec, children: [
        "\u89C2\u5BDF / \u63A8\u65AD\uFF08\u6700\u8FD1 ",
      ...
      p.observations.map((o) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { style: s3.item, children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { style: s3.ts, children: formatLocalDate(o.ts) }),
...
var s4 = {
  ...
  input: { width: "100%", boxSizing: "border-box", padding: "6px 10px", border: "1px solid var(--dsw-alias-border-l2)", borderRadius: 4, fontSize: 13, marginBottom: 8 },
...
function FailoverCard({ installed }) {
  ...
  if (state === "missing") {
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("div", { style: s5.failover, children: "\u6A21\u578B\u964D\u7EA7\u94FE\uFF1A\u672A\u5B89\u88C5 dsh-model-failover\uFF08\u53EF\u9009\u589E\u5F3A\uFF09\u2014\u2014\u5B89\u88C5\u540E\u53EF\u5728\u6B64\u67E5\u770B\u914D\u7F6E\u72B6\u6001\u3002" });
  }
...
function MonitorPage() {
  ...
  const [failoverInstalled, setFailoverInstalled] = (0, import_react5.useState)(false);
  (0, import_react5.useEffect)(() => {
    let alive = true;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("div", { children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(FailoverCard, { installed: failoverInstalled })
  ] });
}
...
var s6 = {
  ...
  colMain: { flex: "1 1 640px", minWidth: 0, display: "flex", flexDirection: "column", gap: 12 },
  colRail: { flex: "1 1 300px", maxWidth: 380, position: "sticky", top: 12, display: "flex", flexDirection: "column", gap: 12 },
  actionRow: { display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" },
  groupLabel: { fontSize: 12, fontWeight: 600, color: "var(--dsw-alias-label-tertiary)", marginRight: 2 },
  ...
  cell: { border: "1px solid var(--dsw-alias-border-l1)", borderRadius: 10, padding: "8px 10px", background: "var(--dsw-alias-bg-layer-1)" },
  cellHead: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 6, marginBottom: 6 },
  fieldLabel: { fontSize: 12.5, color: "var(--dsw-alias-label-secondary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" },
  input: inputBase,
  textarea: { ...inputBase, minHeight: 64, resize: "vertical" },
  select: { ...inputBase, width: "auto", padding: "5px 8px", fontSize: 12.5, flexShrink: 0 },
  list: { maxWidth: 760 },
...
function CardsPage() {
  ...
  const confirmDiscard = () => !dirty || window.confirm("\u5F53\u524D\u6709\u672A\u4FDD\u5B58\u7684\u4FEE\u6539\uFF0C\u7EE7\u7EED\u5C06\u4E22\u5F03\u8FD9\u4E9B\u4FEE\u6539\u3002\u786E\u5B9A\u7EE7\u7EED\uFF1F");
  ...
  const identityCell = (def) => {
    ...
    const control = def.control === "tone" ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("select", { style: { ...s6.select, width: "100%" }, value: f?.value ?? "", onChange: (e) => set({ value: e.target.value }), children: [
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.cell, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.cellHead, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("span", { style: s6.fieldLabel, title: def.label, children: [
          def.label,
  ...
  const statusLine = meta.hasEffective ? `\u4FEE\u8BA2 #${meta.revisionNo} \u5DF2\u751F\u6548` : `\u4FEE\u8BA2 #${meta.revisionNo} \u4E3A\u5019\u9009\u2014\u2014\u751F\u6548\u9700\u8981\uFF1A${confirm ? "" : "\u4E3B\u4EBA\u786E\u8BA4 "}${regressionPassed ? "" : "\u56DE\u5F52\u901A\u8FC7"}`.trim();
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.wrap, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.layout, children: [
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.colMain, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.card, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: s6.grid, children: BUILT_IN_FIELDS2.map((def) => identityCell(def)) }),
          ...
          cards.identity.fields.map((f, i) => BUILT_IN_FIELDS2.some((d) => d.key === f.key) ? null : /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { ...s6.itemRow, maxWidth: 640 }, children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.card, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.list, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.colRail, children: [
        /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.cardHead, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("h2", { style: s6.cardTitle, children: "\u4FDD\u5B58" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s6.cardSub, children: statusLine })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { ...s6.actionRow, padding: 0, border: "none", background: "transparent", marginBottom: 10 }, children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: { display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 8 }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s6.btn, onClick: () => void save(false), children: "\u4FDD\u5B58\u4EBA\u683C\u5361" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s6.btn2, onClick: () => {
              if (confirmDiscard()) void save(true);
            }, children: "\u4ECE\u65E7\u914D\u7F6E\u8FC1\u79FB" }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("button", { style: s6.btn2, onClick: () => {
              if (confirmDiscard()) void load();
            }, children: "\u5237\u65B0" })
          ] }),
          msg !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("div", { style: { ...s6.msg, background: msg.ok ? "var(--dsw-alias-state-success-tertiary)" : "var(--dsw-alias-state-warn-tertiary)", color: msg.ok ? "var(--dsw-alias-state-success-primary)" : "var(--dsw-alias-state-warn-label)" }, children: msg.text })
        ] }),
        preview !== null && /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.card, children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("div", { style: s6.cardHead, children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { style: s6.cardSub, children: "\u5B9E\u9645\u6CE8\u5165\u7684\u7CFB\u7EDF\u63D0\u793A\u8BCD" })
          ] }),
...
function hubIcon(size, active) {
  const color = active ? "var(--dsw-alias-state-business-primary)" : "var(--dsw-alias-label-secondary)";
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("svg", { width: size, height: size, viewBox: "0 0 24 24", fill: "none", "aria-hidden": true, children: [
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("circle", { cx: "12", cy: "8", r: "4", stroke: color, strokeWidth: "2" }),
    /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("path", { d: "M4 20c1.8-3.4 4.6-5 8-5s6.2 1.6 8 5", stroke: color, strokeWidth: "2", strokeLinecap: "round" })
  ] });
}
...
// src/client/suite-dock.tsx
var import_react8 = require("react");

// src/client/suite-dock-model.ts
var DOCK_STORAGE_KEY = "dsh-suite-dock";
var EV_READY = "suite-dock:ready";
var EV_GONE = "suite-dock:gone";
var EV_YUYI_OPEN = "suite-dock:yuyi-open";
var EV_YUYI_STATUS = "suite-dock:yuyi-status";
var EV_MIND_COMPANION = "dsh-mind:companion";
function imTraffic(bots) {
  if (bots === void 0) return "absent";
...
function yuyiTraffic(status) {
  if (status === void 0) return "absent";
  if (status.configured !== true) return "down";
  return status.connected === true ? "ok" : "degraded";
}
function mindTraffic(status) {
  if (status === void 0) return "absent";
...
function trafficColor(t) {
  switch (t) {
    case "ok":
      return "var(--dsw-alias-state-success-primary, #2A9D8F)";
    case "degraded":
      return "var(--dsw-alias-state-warn-primary, #b8860b)";
    default:
      return "var(--dsw-alias-label-tertiary, #999)";
  }
}
...
var POLL_IM_MS = 3e4;
var POLL_MIND_MS = 25e3;
var HEARTBEAT_MS = 3e4;
var YUYI_WAIT_MS = 5e3;
var S = {
  dock: {
    position: "absolute",
    right: 0,
  ...
  badge: {
    ...
    padding: "0 4px",
    borderRadius: 8,
    background: "var(--dsw-alias-state-warn-primary, #b8860b)",
    color: "#fff",
    fontSize: 10,
    fontWeight: 700,
    display: "inline-flex",
...
function useDockHeartbeat() {
  (0, import_react8.useEffect)(() => {
    const beat = () => {
      try {
        localStorage.setItem(DOCK_STORAGE_KEY, (/* @__PURE__ */ new Date()).toISOString());
...
function clickConversationTab(label) {
  try {
...
function Dot({ traffic }) {
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { "aria-hidden": true, style: { ...S.dot, background: trafficColor(traffic) } });
}
function relativeTime(iso) {
  const at = Date.parse(iso);
  if (!Number.isFinite(at)) return iso;
  const m = Math.floor(Math.max(0, Date.now() - at) / 6e4);
  if (m < 1) return "\u521A\u521A";
...
function SuiteDock() {
  useDockHeartbeat();
  const [imBots, setImBots] = (0, import_react8.useState)(void 0);
  const [mind, setMind] = (0, import_react8.useState)(void 0);
  const [yuyi, setYuyi] = (0, import_react8.useState)(void 0);
  const [yuyiSeen, setYuyiSeen] = (0, import_react8.useState)(false);
  const [expanded, setExpanded] = (0, import_react8.useState)(false);
  const [suppressed, setSuppressed] = (0, import_react8.useState)(false);
  (0, import_react8.useEffect)(() => {
    let cancelled = false;
    const load = () => {
      void fetch("/im-channel/bots/status").then((r) => r.json()).then((b) => {
        if (!cancelled) setImBots(b.ok === true ? b.bots ?? [] : void 0);
      }).catch(() => {
        if (!cancelled) setImBots(void 0);
      });
    };
    void load();
  ...
  (0, import_react8.useEffect)(() => {
    ...
    const load = () => {
      void fetch("/dsh-mind/status").then((r) => r.json()).then((b) => {
        if (!cancelled) setMind(b);
      }).catch(() => {
        if (!cancelled) setMind(void 0);
      });
    };
    void load();
  ...
  if (suppressed || yuyi?.panelOpen === true) return null;
  const asks = mind?.openAsks ?? 0;
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
    expanded && im !== "absent" && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { role: "status", style: S.card, children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { fontSize: 13, fontWeight: 600, marginBottom: 6 }, children: "IM \u6E20\u9053" }),
      (imBots ?? []).map((b) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { padding: "6px 0", borderTop: "1px solid var(--dsw-alias-border-l1, rgba(128,128,128,.14))" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, fontSize: 12.5 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Dot, { traffic: b.configured ? b.online ? "ok" : "degraded" : "down" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontWeight: 500 }, children: b.label }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: { opacity: 0.65, fontSize: 11 }, children: [
            !b.configured ? "\u672A\u914D\u7F6E" : b.online ? "\u5728\u7EBF" : "\u79BB\u7EBF",
            b.account !== void 0 && b.account !== "" ? ` \xB7 ${b.account}` : ""
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("span", { style: { marginLeft: "auto", opacity: 0.6, fontSize: 11 }, children: [
            b.boundUsers,
            " \u7ED1\u5B9A"
          ] })
        ] }),
        (b.bindings ?? []).slice(0, 3).map((bd) => /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: { display: "flex", gap: 8, fontSize: 11, opacity: 0.7, padding: "2px 0 0 15px" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { children: bd.isMaster ? "\u{1F451} \u4E3B\u4EBA" : "\u8BBF\u5BA2" }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: bd.userId }),
          /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { whiteSpace: "nowrap" }, children: relativeTime(bd.boundAt) })
        ] }, `${bd.userId}`))
      ] }, b.kind))
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("div", { style: S.dock, children: [
      im !== "absent" && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        "button",
        {
          type: "button",
          title: "IM \u6E20\u9053\uFF08\u70B9\u51FB\u67E5\u770B\u673A\u5668\u4EBA\u72B6\u6001\uFF09",
          "aria-expanded": expanded,
          onClick: () => {
            setExpanded((o) => !o);
          },
          style: { ...S.row, position: "relative" },
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: 12 }, children: "IM" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Dot, { traffic: im })
          ]
        }
      ),
      yu !== "absent" && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        "button",
        {
          type: "button",
          title: "\u5FA1\u9A7F\u534F\u540C\uFF08\u70B9\u51FB\u6253\u5F00\u6D3B\u52A8\u9762\u677F\uFF09",
          onClick: () => {
            window.dispatchEvent(new CustomEvent(EV_YUYI_OPEN));
          },
          style: S.row,
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: 12 }, children: "\u9A7F" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Dot, { traffic: yu })
          ]
        }
      ),
      md !== "absent" && /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(
        "button",
        {
          type: "button",
          title: `\u5FC3\u667A\uFF08${asks > 0 ? `${asks} \u4EF6\u4E8B\u7B49\u4F60\u7ED9\u2014\u2014` : ""}\u70B9\u51FB\u6253\u5F00 TA \u7684\u623F\u95F4\uFF09`,
          onClick: () => {
            clickConversationTab("\u5FC3\u667A");
          },
          style: { ...S.row, position: "relative" },
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: 12 }, children: "\u5FC3\u667A" }),
            /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Dot, { traffic: md }),
            asks > 0 && /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { "aria-hidden": true, style: S.badge, children: asks > 9 ? "9+" : asks })
          ]
        }
      )
    ] })
...
function applySuiteDock(ctx) {
  const slots = ctx.slots;
  const railMode = typeof slots.spec === "function" && slots.spec("main") !== void 0;
  try {
    if (railMode) {
      ctx.slots.inject("sidebar.panellist", () => ctx.slots.register(
        { name: "sidebar.panellist", id: "suite-dock", order: 18, label: () => "\u5957\u4EF6" },
        (props) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("span", { style: { fontSize: Math.min(13, props.size * 0.5), lineHeight: 1 }, children: "\u5957\u4EF6" })
      ));
      ctx.slots.inject("main", () => ctx.slots.register(
        { name: "main", key: "suite-dock" },
        () => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("div", { style: { padding: "18px 20px" }, children: /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SuiteDock, {}) })
      ));
    } else {
      ctx.slots.inject("shell.overlay", () => ctx.slots.register(
        { name: "shell.overlay", id: "twin-suite-dock", order: 85, label: () => "\u5957\u4EF6\u72B6\u6001\u575E" },
        () => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(SuiteDock, {})
      ));
    }
  } catch (e) {
...
function apply(ctx) {
  ctx.slots.inject(
    ...
    () => ctx.slots.register(
      ...
      (props) => props.view === "page" ? /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TwinSettingsPage, {}) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("span", { style: { fontSize: 12, color: "var(--dsw-alias-label-secondary)" }, children: "\u5206\u8EAB\u4EBA\u683C\u7ECF\u56DB\u5F20\u5361\u6295\u5F71\u6CE8\u5165\u5404\u4F1A\u8BDD\uFF1B\u6B64\u5904\u7BA1\u7406\u6A21\u677F / \u77E5\u8BC6\u79CD\u5B50 / \u4EBA\u683C\u5361\u5BFC\u5165\u5BFC\u51FA\uFF0C\u65E5\u5E38\u8FD0\u8425\u5728\u4F1A\u8BDD\u300C\u6570\u5B57\u5206\u8EAB\u300DTab\u3002" })
    )
  );
  applyTwinHub(ctx);
  applySuiteDock(ctx);
...
var PRESETS = [
  { id: "custom", label: "\u81EA\u5B9A\u4E49", desc: "\u751F\u6210\u7A7A\u767D\u4EBA\u683C\u5361\uFF0C\u5230\u4EBA\u683C\u5361\u9010\u9879\u586B\u5199\u3002", toolHint: "\u81EA\u5B9A\u4E49\u89D2\u8272\uFF1A\u8BF7\u6309\u9700\u5728\u300C\u63D2\u4EF6\u9875 \u2192 IM \u6E20\u9053 \u2192 \u8BBF\u5BA2\u6743\u9650\u300D\u5F00\u653E\u5DE5\u5177\u3002", fields: {}, seeds: [] },
...
function TwinSettingsPage() {
  const [cfg, setCfg] = (0, import_react9.useState)(emptyConfig);
  ...
  const [toolHint, setToolHint] = (0, import_react9.useState)("");
  const [stats, setStats] = (0, import_react9.useState)(null);
  const [cardsState, setCardsState] = (0, import_react9.useState)(null);
  const [tab, setTab] = (0, import_react9.useState)("persona");
  ...
  const s8 = {
    ...
    input: { width: "100%", boxSizing: "border-box", padding: "6px 10px", border: "1px solid var(--dsw-alias-border-l2)", borderRadius: "4px", fontSize: "13px" },
    textarea: { width: "100%", boxSizing: "border-box", padding: "6px 10px", border: "1px solid var(--dsw-alias-border-l2)", borderRadius: "4px", fontSize: "13px", minHeight: "54px", resize: "vertical" },
    chipRow: { display: "flex", gap: "8px", flexWrap: "wrap", marginBottom: "12px" },
    chip: { padding: "5px 12px", border: "1px solid var(--dsw-alias-border-l2)", borderRadius: "16px", fontSize: "13px", cursor: "pointer", background: "var(--dsw-alias-bg-layer-2)" },
    chipOn: { padding: "5px 12px", border: "1px solid var(--dsw-alias-state-business-primary)", borderRadius: "16px", fontSize: "13px", cursor: "pointer", background: "var(--dsw-alias-interactive-bg-active)", color: "var(--dsw-alias-state-business-primary)", fontWeight: 600 },
    templateGrid: { display: "flex", gap: "10px", flexWrap: "wrap", justifyContent: "center", marginBottom: "12px" },
    templateCard: { width: "160px", padding: "12px 12px 10px", border: "1px solid var(--dsw-alias-border-l2)", borderRadius: "10px", textAlign: "center", cursor: "pointer", background: "var(--dsw-alias-bg-layer-2)", transition: "all 0.15s" },
    ...
    tabBar: { display: "flex", gap: "4px", borderBottom: "1px solid var(--dsw-alias-border-l2)", marginBottom: "14px" },
    ...
    tabOn: { padding: "8px 14px", fontSize: "13px", border: "none", background: "transparent", cursor: "pointer", color: "var(--dsw-alias-state-business-primary)", fontWeight: 600, borderBottom: "2px solid var(--dsw-alias-state-business-primary)" },
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: s8.wrap, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("h1", { style: s8.h, children: "\u6570\u5B57\u5206\u8EAB\u8BBE\u7F6E" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("p", { style: s8.sub, children: "\u5206\u8EAB\u7684\u521D\u59CB\u5316\u4E0E\u6570\u636E\u7BA1\u7406\uFF1A\u6A21\u677F\u4E00\u952E\u751F\u6210\u521D\u7248\u4EBA\u683C\u5361\u3001\u77E5\u8BC6\u79CD\u5B50\u5199\u5165\u5171\u4EAB\u8BB0\u5FC6\u3001\u4EBA\u683C\u5361\u5BFC\u5165\u5BFC\u51FA\u3002\u4EBA\u683C\u7F16\u8F91\u4E0E\u8FD0\u884C\u76D1\u63A7\u5728\u4E3B\u5BF9\u8BDD\u7A97\u53E3\u300C\u6570\u5B57\u5206\u8EAB\u300DTab\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.tabBar, children: [["persona", "\u4EBA\u683C"], ["knowledge", "\u77E5\u8BC6"]].map(([id, label]) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { style: tab === id ? s8.tabOn : s8.tab, onClick: () => setTab(id), children: label }, id)) }),
    tab === "persona" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: s8.section, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.secTitle, children: "\u6A21\u677F\u9884\u8BBE\uFF08\u4E00\u952E\u751F\u6210\u521D\u7248\u4EBA\u683C\u5361\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.templateGrid, children: PRESETS.map((p) => /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: cfg.template === p.id ? { ...s8.templateCard, ...s8.templateCardOn } : s8.templateCard, onClick: () => applyPreset(p.id), children: [
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.templateName, children: p.label }),
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.templateDesc, children: p.desc }),
        cfg.template === p.id && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.templateCheck, children: "\u2713 \u5DF2\u9009" })
      ] }, p.id)) }),
      toolHint && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: s8.hint, children: [
        "\u{1F6E1}\uFE0F ",
        toolHint
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.secTitle, children: "\u5F53\u524D\u4EBA\u683C\uFF08\u53EA\u8BFB\u6458\u8981\uFF09" }),
      cardsState ? /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: s8.hint, children: [
        "\u4EBA\u683C\u5361\u4FEE\u8BA2 ",
        ...
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("br", {}),
        "\u7F16\u8F91\u4EBA\u683C\u8BF7\u5230 ",
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("b", { children: "\u4E3B\u5BF9\u8BDD\u7A97\u53E3\u300C\u6570\u5B57\u5206\u8EAB\u300DTab \u2192 \u4EBA\u683C\u5361" }),
        "\uFF08\u6B64\u5904\u4E0D\u518D\u63D0\u4F9B\u7B2C\u4E8C\u4E2A\u4EBA\u683C\u7F16\u8F91\u5668\uFF0C\u907F\u514D\u53CC\u6E90\u51B2\u7A81\uFF09\u3002"
      ] }) : /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.hint, children: "\u4EBA\u683C\u5361\u5C1A\u672A\u52A0\u8F7D\uFF08\u670D\u52A1\u7AEF\u4E0D\u53EF\u7528\uFF1F\uFF09\u3002" })
    ] }),
    tab === "knowledge" && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: s8.section, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.secTitle, children: "\u77E5\u8BC6\uFF08\u5171\u4EAB\u8BB0\u5FC6\u79CD\u5B50\uFF09" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("label", { style: s8.label, children: "\u8BB0\u5FC6\uFF08\u6BCF\u884C\u4E00\u6761\uFF09" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("label", { style: { ...s8.ghost, display: "inline-block", marginTop: "8px" }, children: [
        "\u5BFC\u5165\u77E5\u8BC6\u6587\u4EF6(.txt/.md)",
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("input", { type: "file", accept: ".txt,.md,.markdown,text/plain", style: { display: "none" }, onChange: handleImportKnowledge })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { ...s8.hint, marginTop: 10 }, children: "\u6B64\u5904\u7F16\u8F91\u7684\u662F\u300C\u79CD\u5B50\u300D\uFF1B\u4FDD\u5B58\u540E\u5199\u5165\u5171\u4EAB\u8BB0\u5FC6\u5E93\u3002\u8981\u67E5\u770B / \u7F16\u8F91 / \u5220\u9664\u5DF2\u5165\u5E93\u7684 \u5355\u6761\u8BB0\u5FC6\uFF08\u542B\u5206\u8EAB\u5BF9\u8BDD\u4E2D\u6C89\u6DC0\u7684\u8BB0\u5FC6\uFF09\uFF0C\u8BF7\u5230\u5DE6\u4FA7\u300C\u8BB0\u5FC6\u300D\u6807\u7B7E\u9875\uFF08dsh-memory \u63D0\u4F9B\uFF09\u3002" })
    ] }),
    stats && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: s8.hint, children: [
      "\u72B6\u6001\uFF1A\u8BB0\u5FC6 ",
      stats.memoryTotal,
      " \u6761",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("label", { style: { ...s8.hint, display: "flex", alignItems: "center", gap: 6, cursor: "pointer" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
        "input",
        {
          type: "checkbox",
    ...
    cfg.becomeDefaultPreset === true && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: { ...s8.hint, color: "var(--dsw-alias-state-success-primary)" }, children: "\u2713 \u6570\u5B57\u5206\u8EAB\u9884\u8BBE\u5DF2\u5305\u542B\u5168\u90E8\u5DE5\u5177\uFF08shell / \u6587\u4EF6\u7CFB\u7EDF / \u8054\u7F51\u7B49\uFF09\u3002\u52FE\u9009\u540E\u6240\u6709\u65B0\u4F1A\u8BDD\u90FD\u4EE5\u4F60\u7684\u5206\u8EAB\u8EAB\u4EFD\u5DE5\u4F5C\uFF1A\u4EBA\u683C\u3001\u8BB0\u5FC6\u3001\u5DE5\u5177\u5B8C\u5168\u4E00\u81F4\u3002\u8BBF\u5BA2\u4F1A\u8BDD\u4ECD\u6309\u8BBF\u5BA2\u6743\u9650\u767D\u540D\u5355\u53D7\u9650\uFF0C\u4E0D\u53D7\u5F71\u54CD\u3002" }),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: s8.row, children: [
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { style: s8.btn, disabled: !loaded || saving, onClick: handleSave, children: saving ? "\u4FDD\u5B58\u4E2D\u2026" : "\u4FDD\u5B58\u5E76\u751F\u6548" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { style: s8.ghost, onClick: handlePreviewToggle, children: preview ? "\u6536\u8D77\u9884\u89C8" : "\u9884\u89C8\u6CE8\u5165\u7684\u4EBA\u683C" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("button", { style: s8.ghost, onClick: handleExport, children: "\u5BFC\u51FA\u4EBA\u683C\u5361" }),
      /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("label", { style: s8.ghost, children: [
        "\u5BFC\u5165\u4EBA\u683C",
        /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("input", { type: "file", accept: "application/json", style: { display: "none" }, onChange: handleImport })
      ] })
    ] }),
    preview && /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("pre", { style: { ...s8.hint, whiteSpace: "pre-wrap", background: "rgba(127,127,127,0.12)", padding: 10, borderRadius: 8, maxHeight: 260, overflow: "auto" }, children: [
      preview.persona || "\uFF08\u4EBA\u683C\u4E3A\u7A7A\uFF1A\u540D\u5B57/\u98CE\u683C\u7B49\u5B57\u6BB5\u5168\u7A7A\u65F6\u4E0D\u6CE8\u5165\u4EBA\u683C\u6BB5\uFF09",
      preview.guard ? `

${preview.guard}` : ""
    ] }),
    status && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("div", { style: s8.status, children: status })
  ] });
}
